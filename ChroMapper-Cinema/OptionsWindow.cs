...
internal class OptionsWindow : UIWindow {
	...
	public void Refresh() {
		...
		AddExpando("cinemaAdvanced", "Advanced Settings", false); {
			...
			// TODO: Needs a three-option dropdown
			MakeCheckbox("Allow Custom Platform", "allowCustomPlatform", false, "When set to false, will prevent the CustomPlatforms mod from loading a custom platform for this map if the video is playing.");
			...
			// TODO: Needs a three-option dropdown
			MakeCheckbox("Transparency", "transparency", false, "Override the user's choice and force transparency to be enabled or disabled.");
		...
		AddExpando("cinemaVignette", "Vignette", false); {
			// TODO: Dropdown
			MakeTextbox("Type", "vignette.type", "Either \"elliptical\" or \"rectangular\". Changes how the radius and softness parameters behave.");
